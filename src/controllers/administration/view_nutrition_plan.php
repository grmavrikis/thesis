...
{
    header('Location: ' . $seoUrl->generate('administration/nutrition_plan.php'));
    exit();
}
$breadcrumb = new Breadcrumb();
$breadcrumb->addItem(TEXT_NUTRITION_PLAN, $seoUrl->generate('administration/nutrition_plan.php'));
...
$nutrition_plan = $db->query($sql, [$_GET['id']])->fetch();
...
$form_schema = [
    ...
    'cancel_url' => $seoUrl->generate('administration/nutrition_plan.php'),
