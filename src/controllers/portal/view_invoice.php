...
{
    header('Location: ' . $seoUrl->generate('portal/invoice.php'));
    exit();
}
$breadcrumb = new Breadcrumb();
$breadcrumb->addItem(TEXT_INVOICE, $seoUrl->generate('portal/invoice.php'));
...
{
    $cancel_url = $seoUrl->generate('portal/view_appointment.php', ['id' => $_GET['appointment_id']]);
}
else
{
    $cancel_url = $seoUrl->generate('portal/invoice.php');
}
