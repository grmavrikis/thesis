...
{
    header('Location: ' . $seoUrl->generate('administration/questionnaire.php'));
    exit();
}
$breadcrumb = new Breadcrumb();
$breadcrumb->addItem(TEXT_QUESTIONNAIRE, $seoUrl->generate('administration/questionnaire.php'));
...
$questionnaire = $db->query($sql, [$_GET['id']])->fetch();
...
$form_schema = [
    ...
    'cancel_url' => $seoUrl->generate('administration/questionnaire.php'),
