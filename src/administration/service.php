...
<body>
                                ...
                                <div class="listing-toolbar">
                                    ...
                                    <div class="toolbar-right">
                                        <div class="search-container">
                                            ...
                                            <div id="searchTrigger" class="search-icon-wrapper" data-api-url="/ajax/get_services.php">
                                        ...
                                        <button type="button" id="btn-bulk-delete" class="action-btn btn-outline-danger" data-delete-url="/ajax/delete_services.php" disabled>
                                            <?php echo TEXT_DELETE; ?> (<span id="selected-count">0</span>)
                                        </button>
                                        <a href="<?php echo $seoUrl->generate('administration/create_service.php'); ?>" id="btn-add-new" class="action-btn btn-primary">
                                            <?php echo TEXT_ADD; ?>
                                        </a>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            initDynamicTable('table-root', '/ajax/get_services.php');
        });
    </script>
    <?php
