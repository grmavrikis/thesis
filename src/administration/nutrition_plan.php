...
<body>
                                ...
                                <div class="listing-toolbar">
                                    ...
                                    <div class="toolbar-right">
                                        <div class="search-container">
                                            ...
                                            <div id="searchTrigger" class="search-icon-wrapper" data-api-url="/ajax/get_nutrition_plans.php">
                                        ...
                                        <button type="button" id="btn-bulk-delete" class="action-btn btn-outline-danger" data-delete-url="/ajax/delete_nutrition_plans.php" disabled>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            initDynamicTable('table-root', '/ajax/get_nutrition_plans.php');
        });
    </script>
    <?php
